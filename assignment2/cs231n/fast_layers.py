...
# 在windows中python setup.py build_ext --inplace执行不成功，不使用cython的函数
# 原来的代码在fast_layers2.py
# try:
...
# 编程不了，用原来的版本
conv_forward_strides = conv_forward_im2col
conv_backward_strides = conv_backward_im2col
